      ...
      <div class="wrapper fadeInDown">
              <div id="formContent">
                ...
                <form v-on:submit.prevent="iniciarSesion()">
                  <input type="email" id="correo" class="fadeIn second" name="login" placeholder="Correo Electronico" v-model="correo">
                  <input type="password" id="contrasena" class="fadeIn third" name="login" placeholder="Contraseña" v-model="contrasena">
